...
class QuotesSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for quote in response.xpath('//item'):
            # print("quote == ",quote)
            pubDate=quote.xpath('.//pubDate/text()').get().replace(" -0500","") #Thu, 12 May 2022 17:43:01 +0000
            ...
            if self.SavedDate<date_time_obj:
                ...
                sql = "insert into bulk_feed_content(bfw_id,url,title) values(%s,%s,%s)"
                val = (response.meta['bfw_id'],url, title)
