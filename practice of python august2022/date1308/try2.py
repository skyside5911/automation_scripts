...
for page in range(1,40):
    ...
    for p in data:
        ...
        print(imageURL)
        print(type(imageURL))
        img = Image. open(BytesIO(se. content))
        print(img)
        print(type(img))
        I1 = ImageDraw.Draw(img)
        # img = Image.open(bytes(imageURL),decoding='utf8')
        ...
        aaa=str(img).save("https://theleafdesk.com/wp-content/uploads/2022/09/shutter_"+str(count)+'.jpg')
        print(aaa)
