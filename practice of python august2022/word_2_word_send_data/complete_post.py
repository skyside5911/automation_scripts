...
urll ="https://www.onlinecasinogames777.com/wp-json/wp/v2/categories/"
        ...
        for e in list_of_id:
            if c in e.keys():
                ...
                for f in value:
                    ...
                    header = {'Authorization': 'Bearer ' + token}
                    re = requests.post(urll , headers=header, json=poost)
                    print(re)
...
updatedpost = {'title'    : title,
    ...
    'date'   : date, "categories":int(postid_category),
